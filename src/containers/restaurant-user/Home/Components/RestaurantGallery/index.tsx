export default function RestaurantGallery() {
  return (
    <div className="hidden lg:block w-4/5 mx-auto mt-2 overflow-hidden"> {/* Thêm overflow-hidden */}
        ...
        <div className="hidden md:col-span-2 md:flex flex-col gap-2">
          <div className="flex-1 flex flex-col md:flex-row">
            <img
              ...
              alt="Image 1"
              className="w-full h-auto object-cover mb-1 md:mb-0 md:mr-1" 
            />
            <img
              src="https://res.cloudinary.com/dnslrwedn/image/upload/v1727081570/image_1_r4abui.png"
              
              alt="Image 2"
              className="w-full h-auto object-cover mt-1 md:mt-0 md:ml-1" 
            />
          </div>
          <img
