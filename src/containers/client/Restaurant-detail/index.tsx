    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        <div className="w-full max-w-screen-xl mx-auto mt-10 px-4">
          ...
          <div className="mt-6 bg-amber-100 p-6 rounded-lg shadow-md">
            <p className="text-lg md:text-xl text-black font-medium mb-4">
              Nhập mã: <span className="font-bold text-red-600">COMTAM10</span>{' '}
              để được giảm 10% cho đơn hàng từ 100,000đ trở lên.
            </p>
