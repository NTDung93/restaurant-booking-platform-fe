...
const RestaurantDetail: React.FC = () => {
  ...
  <div className="relative bg-amber-100 text-black mt-6 p-6 rounded-lg shadow-lg border-2  border-black w-full md:w-2/5 mx-auto flex flex-col justify-between" style={{ height: '250px' }}>
    {/* Phần trên (2/3) */}
    <div className="flex-grow">
      <p className="text-lg md:text-xl font-medium mb-4">
        Nhập mã: <span className="font-bold text-red-600">COMTAM10</span> để được giảm 10% cho đơn hàng từ 100,000đ trở lên.
      </p>
